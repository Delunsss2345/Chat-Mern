        ...
        <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
            <div className="space-y-6">
                <div className="flex flex-col gap-1">
                    <h2 className="text-lg font-semibold text-base-content">Theme</h2> {/* Thêm text-base-content */}
              ...
              `}
                ...
                {/* Preview Section */}
                <h3 className="text-lg font-semibold mb-3 text-base-content">Preview</h3> {/* Thêm text-base-content */}
