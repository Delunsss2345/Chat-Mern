...
const MessageInput = () => {
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            ...
            console.error("Failed to send mess", error);
        }
    }
    return (<div className="p-4 w-full">
        ...
        <form onSubmit={handleSendMessage} className="flex items-center gap-2">
            <div className="flex-1 flex gap-2">
                <input type="text" className="w-full input rounded-lg input-sm sm:input-md"
                ...
                <button type="button" className={`flex items-center justify-center btn btn-circle`}
